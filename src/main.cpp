...
int deltaEnc1, deltaEnc2, deltaEnc3;
int enc1, enc2, enc3;
...
const unsigned long readInterval = 75; // For IR and Battery readings
...
void calculateWheelVelocity() {
  ...
  deltaEnc1 = enc1 - prevEnc1;
  deltaEnc2 = enc2 - prevEnc2;
  deltaEnc3 = enc3 - prevEnc3;
...
void sendDataROS() {
  Serial.print("DEN:");
  Serial.print(deltaEnc1);
  Serial.print(",");
  Serial.print(deltaEnc2);
  Serial.print(",");
  Serial.print(deltaEnc3);
